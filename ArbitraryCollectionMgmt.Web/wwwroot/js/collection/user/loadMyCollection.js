...
function loadMyCollection() {
    datatable = $('#tblData').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": `/collection/get-my-collection?categoryId=${categoryId}`,
            "type": "GET",
            "data": function (d) {            
        ...
        "columns": [
            { data: 'collectionId', width: '3%', "className": "dt-right" },
            { data: 'name', width: '15%' },
...
function GoToItemList(id) {
    window.location.href = "/item/my-item/collection/" + id;
}


function EditCollection(id) {
    window.location.href = "/collection/my-collection/edit/" + id;
}
